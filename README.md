...
1) Web browser obtain the IP address from the domain name
2) The browser demands the full url from the server 
3) The web server responds to the browser by sending the desired pages, and in case, the pages do not exist or some other error occurs, it will send the appropriate error message.
4) The Browser finally gets the webpages and displays it or displays the error message.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

1) UPDATE HTTP request method
2) DELETE HTTP request method
